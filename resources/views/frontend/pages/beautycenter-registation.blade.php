...
@section('title','Beauty Center Registation')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h4 class="after-dot-auto">@lang('registation.beautycenterregistation') </h4>
                    </div>
                </div>
            </div>
            <div class="registation-form pt-5">
                <form action="{{route('beauty-center.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="name">@lang('registation.beautycentername')<span>*</span></label>
                                <input type="text" name="name_en" value="{{old('name_en')}}" class="custom-form" id="name" placeholder="@lang('registation.beautycentername')">
                                <div class="text-danger error text-capitalize">{{$errors->first('name_en')}}</div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="name_ar">@lang('registation.beautycenternameababic') <span>*</span></label>
                                <input type="text" name="name_ar" value="{{old('name_ar')}}" class="custom-form" id="name_ar" placeholder="@lang('registation.beautycenternameababic')">
                                <div class="text-danger error text-capitalize">{{$errors->first('name_ar')}}</div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="owner">@lang('registation.beautycenterownername') <span>*</span></label>
                                <input type="text" name="owner" value="{{old('owner')}}" class="custom-form" id="name" placeholder="@lang('registation.beautycenterownername')">
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="address">@lang('registation.beautycenteraddress') <span>*</span></label>
                                <textarea name="address" class="custom-form"  placeholder="@lang('registation.beautycenteraddress')">{{old('address')}}</textarea>
