...
@section('title','Hospital Registation')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h4 class="after-dot-auto">@lang('registation.hospitalregistation')</h4>
                    </div>
                </div>
            </div>
            <div class="registation-form pt-5">
                <form action="{{route('hospital.registation.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-6">
                        <div class="mb-3">
                            <label for="name">@lang('registation.hospitalname') <span>*</span></label>
                            <input type="text" name="name" value="{{old('name')}}" class="custom-form" id="name" placeholder="@lang('registation.hospitalname')">
                            <div class="text-danger error text-capitalize">{{$errors->first('name')}}</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-6">
                        <div class="mb-3">
                            <label for="name_ar">@lang('registation.hospitalarbicname')<span>*</span></label>
                            <input type="text" name="name_ar" value="{{old('namea_ar')}}" class="custom-form" id="name_ar" placeholder="@lang('registation.hospitalarbicname')">
                    ...
                    <div class="col-12 col-sm-6 col-lg-6">
                        <div class="mb-3">
                            <label for="email">@lang('registation.email')</label> <span>*</span></label>
                    ...
                    <div class="col-12 col-sm-6 col-lg-6">
                        <div class="mb-3">
                            <label for="address">@lang('registation.hospitaladdress') <span>*</span></label>
                            <textarea name="address" class="custom-form"  placeholder="@lang('registation.hospitaladdress')">{{old('address')}}</textarea>
