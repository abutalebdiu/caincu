...
@section('title','Pharmacy Registation')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h4 class="after-dot-auto">@lang('registation.pharmacyRegistation')</h4>
                    </div>
                </div>
            </div>
            <div class="registation-form pt-5">

                <form action="{{route('farmacy.registation.store')}}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="name">@lang('registation.pharmacyname')<span>*</span></label>
                                <input type="text" name="name" value="{{old('name')}}" class="custom-form" id="name" placeholder="@lang('registation.pharmacyname')">
                                <div class="text-danger error text-capitalize">{{$errors->first('name')}}</div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="name_ar">@lang('registation.pharmacyarbicname') <span>*</span></label>
                                <input type="text" name="name_ar" value="{{old('name_ar')}}" class="custom-form" id="name_ar" placeholder="@lang('registation.pharmacyarbicname')">
                                <div class="text-danger error text-capitalize">{{$errors->first('name_ar')}}</div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="owner">@lang('registation.pharmacyownername') <span>*</span></label>
                                <input type="text" name="owner" value="{{old('owner')}}" class="custom-form" id="name" placeholder="@lang('registation.pharmacyownername')">
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                <label for="address">@lang('registation.pharmacyaddress') <span>*</span></label>
                                <textarea name="address" class="custom-form"  placeholder="@lang('registation.pharmacyaddress')">{{old('address')}}</textarea>
