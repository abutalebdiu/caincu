                                ...
                                <div class="form-group">
                                    <label for="">Vendor</label>
                                     <select name="vendor_id" id="" class="form-control">
                                         ...
                                         <option {{ $product->vendor_id == $user->id ? 'selected' : '' }} value="{{$user->id}}">{{$user->name }}</option>
                                         @endforeach
                                     </select>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text"  name="name" value="{{ $product->title  }}" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)"  class="form-control" placeholder="Enter Product Name" /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="ar_name" value="{{ $product->ar_title  }}" class="form-control" placeholder="Enter Category Arabic Name" /> 
                                        <div class="text-danger">{{ $errors->first('ar_name') }}</div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="">Slug</label>
                                        <textarea name="slug" id="slug-text" class="form-control" placeholder="Enter Product Slug">{{ $product->slug }}</textarea>
                                        <div class="text-danger">{{ $errors->first('slug') }}</div>
                                    </div>

                                     <div class="form-group">
                                        <label for="">Generic</label>
                                        <textarea name="generic" class="form-control" placeholder="Enter Product Generic">{{ $product->generic }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <label for="">Brand</label>
                                         <select name="brand_id" id="" class="form-control">
                                             ...
                                             <option {{ $product->brand_id == $brand->id ? 'selected' : '' }} value="{{ $brand->id }}">{{ $brand->en_name }}</option>
                                             @endforeach
                                         </select>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                     	...
                                     	<img src="{{ asset($product->default_image) }}" alt="" width="100">
