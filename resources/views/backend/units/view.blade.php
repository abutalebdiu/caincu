 ...
 <div id="content" class="content">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Product Unit List</h4>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                               	...
                               	<a href="{{ route('unit.edit',$unit->id) }}" class="btn btn-xs btn-success">
                            		<i class="fa fa-edit"></i> Edit
                            	</a> 
                            	 
                            	</a> 
                            	<a href="{{ route('unit.destroy',$unit->id) }}" id="delete" class="btn btn-xs btn-danger">
