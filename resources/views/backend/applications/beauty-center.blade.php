...
@section('title','Beauty Center List')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Beauty Center List</h4>
                    ...
                    @foreach($beauty as  $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('application.beauty.center.show',$data->id)}}"  class="btn btn-xs btn-aqua">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('beauty.center.change.update',$data->id)}}" method="post">
                                                @csrf
                                                <div>
