...
@section('title','Medical-center List')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Medical Center List</h4>
                    ...
                    @foreach($medicals as  $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('application.medical-center.show',$data->id)}}"  class="btn btn-xs btn-aqua">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Change Status {{$data->id}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="{{route('medical.change.update',$data->id)}}" method="post">
                                                @csrf
                                                <div>
