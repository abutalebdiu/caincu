    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Gym List</h4>
                    ...
                    @foreach($gym as  $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('application.gym.show',$data->id)}}"  class="btn btn-xs btn-aqua">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('gym.change.update',$data->id)}}" method="post">
                                                @csrf
                                                <div>
