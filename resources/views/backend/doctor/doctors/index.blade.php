            ...
            <div class="panel-body">
                <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                    ...
                    <tr>
                        ...
                        <th class="text-nowrap">Doctor Name(Ar)</th>
                    ...
                    @foreach($doctors as  $data)
                        <tr>
                            ...
                            <td>{{ $data->name }}</td>
                            <td>{{ $data->name_ar }}</td>
                            <td>{{ $data->specialty ? $data->specialty->name:'no user'  }}</td>
                            ...
                            <td>
                                <a href="{{ route('doctor.destroy',$data->id) }}" id="delete" class="btn btn-xs btn-danger">
                                    <i class="fa fa-times"></i> Delete
                                </a>
                                <a href="{{ route('doctor.edit',$data->id) }}" class="btn btn-xs btn-danger">
