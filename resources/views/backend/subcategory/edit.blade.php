                ...
                <div class="col-xl-6">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-10">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('categorysub.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                  <div class="form-group">
                                        <label for="">Name</label>
                                         <select name="category_id" id="" class="form-control">
                                             ...
                                             <option {{$category->parent_id == $categor->id ? 'selected' : '' }}  value="{{$categor->id}}">{{$categor->name }}</option>
                                             @endforeach
                                         </select>
